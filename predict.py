...
numPredict = numTrain + numTest


print("In the original data:")
print("# of miss in training data: ", f["/data/missTrain"].shape[0])
print("# of hit  in training data: ", f["/data/hitTrain"].shape[0])
print("# of miss in testing  data: ", f["/data/missTest"].shape[0])
print("# of hit  in testing  data: ", f["/data/hitTest"].shape[0])

print("# of final prediction data: ", numPredict)

X_val = np.empty((numPredict, 1, imgShape[0], imgShape[1]))
y_val = np.empty((numPredict,),dtype=int)
